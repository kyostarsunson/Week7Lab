    ...
    <body>
        ...
        <c:if test="${selectuser ne null}">
            ...
            <form method="post" action="UserServlet">
                ...
                First Name<input type='textbox' name='firstInput' value="${selectuser.first}"><br>
                Last Name<input type='textbox' name='lastInput' value="${selectuser.last}"><br>
                Password:<input type='password' name='passwordInput' value="${selectuser.password}"><br>
                Role:${selectuser.role}<select>
